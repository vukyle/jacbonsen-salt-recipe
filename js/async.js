var importMenu = {
    ...
    createMenu: function (data) {
        ...
        function createMenuItem(name, price, description, boolean) {
            //debugger;
        ...
        for (var i = 0; i < newMenu.menu.length; i++) {
            for (var j = 0; j < newMenu.menu[i].type.length; j++) {
                if (j === 0) {
                    ...
                    var boolean = newMenu.menu[i].type[1];

                    menuContainer.appendChild(createMenuItem(name, price, description, boolean));
                }
            }
        }
    },
